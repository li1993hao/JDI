...
public class MediaFile {
    ...
    //文件
    public static final int FILE_TYPE_WORD1     = -1;
    public static final int FILE_TYPE_WORD2     = -2;
    public static final int FILE_TYPE_EXC1     = -3;
    public static final int FILE_TYPE_EXC2    = -4;
    public static final int FILE_TYPE_TXT     = -5;
    public static final int FILE_TYPE_PDF     = -6;
    public static final int FILE_TYPE_CHM     = -7;
    public static final int FILE_TYPE_PPT     = -8;
    public static final int FILE_TYPE_APK     = -9;
    public static final int FILE_TYPE_HTML1     = -10;
    public static final int FILE_TYPE_HTML2     = -11;
    ...
    static {
        addFileType("DOC", FILE_TYPE_WORD1, "application/msword");
        addFileType("DOCX", FILE_TYPE_WORD2, "application/msword");
        addFileType("XLSX", FILE_TYPE_EXC1, "application/vnd.ms-excel");
        addFileType("XLS", FILE_TYPE_EXC2, "application/vnd.ms-excel");
        ...
        addFileType("HTML", FILE_TYPE_HTML1, "text/html");
        addFileType("HTM", FILE_TYPE_HTML2, "text/html");
